...
public class Example {
    ...
    public static void main(String[] args) throws Exception {
        String appKey = "cpj2xarlc6uyn";//替换成您的appkey
        String appSecret = "0jWG8MQnoa";//替换成匹配上面key的secret
        ...
        try {
            ...
            MsgObj message = new MsgObj("xiaolong_test123", "RC:TxtMsg");
            broadcastPushPushMessage.setMessage(message);
